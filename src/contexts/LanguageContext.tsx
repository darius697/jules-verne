...
const translations = {
  ro: {
    ...
    // Hero
    eliteKindergarten: "Grădinița Privată",
    adventuresInLearning: "Aventuri în Învățare",
    heroDescription:
      "Descoperă lumea magică a învățării alături de noi! La Jules Verne, fiecare zi este o nouă aventură plină de explorări, creativitate și bucurie.",
    ...
    aboutDescription:
      "De peste 15 ani, grădinița Jules Verne este un loc special unde copiii învață, explorează și își dezvoltă personalitatea într-un mediu sigur și stimulativ.",
    ourMission: "Misiunea Noastră",
    missionDescription1:
      "Inspirați de spiritul aventuros al lui Jules Verne, creăm pentru copii o lume plină de descoperiri și învățare. Fiecare zi la grădinița noastră este o nouă călătorie în universul cunoașterii.",
    missionDescription2:
      "Valorile noastre fundamentale sunt respectul, creativitatea, colaborarea și bucuria de a învăța. Pregătim copiii pentru viitor, dezvoltându-le încrederea în sine și dragostea pentru cunoaștere.",
    ...
    innovativeEducationDesc:
      "Curriculum personalizat care stimulează creativitatea și curiozitatea naturală a copiilor.",
    qualifiedEducators: "Educatori Calificați",
    qualifiedEducatorsDesc:
      "Echipa noastră de profesori pasionați și certificați îi ghidează pe copii cu dragoste.",
    flexibleSchedule: "Program Flexibil",
    flexibleScheduleDesc:
      "Orar adaptat nevoilor familiei tale, cu opțiuni de prelungit și activități extra.",
    personalizedDevelopment: "Dezvoltare Personalizată",
    personalizedDevelopmentDesc:
      "Atenție individuală pentru fiecare copil, respectând ritmul său de dezvoltare.",

    // Programs
    ourPrograms: "Programele Noastre Educaționale",
    programsDescription:
      "Fiecare grupă de vârstă beneficiază de un program personalizat, adaptat nevoilor de dezvoltare specifice copiilor.",
    ...
    extracurricularDescription:
      "Completăm educația cu activități opționale care dezvoltă talentele și pasiunile copiilor.",
    ...
    smallGroupDescription:
      "Primii pași în lumea educației printr-o abordare blândă și adaptată vârstei.",
    middleGroupDescription:
      "Explorarea lumii prin creativitate, experimentare și activități interactive.",
    bigGroupDescription:
      "Pregătirea pentru școală prin activități complexe și dezvoltarea autonomiei.",
    preparatoryGroupDescription:
      "Tranziția către învățământul primar prin consolidarea competențelor dobândite.",
    ...
    galleryDescription:
      "Urmărește momentele speciale și activitățile zilnice ale copiilor la Jules Verne.",
    ...
    contactDescription:
      "Suntem aici să răspundem la toate întrebările tale și să te ajutăm să descoperi de ce Jules Verne este alegerea perfectă pentru copilul tău.",
    phone: "Telefon",
    email: "Email",
    schedule: "Program",
    address: "Adresă",
    ...
    visitDescription:
      "Vino să vezi cum arată o zi la Jules Verne! Oferim vizite ghidate pentru părinți și copii.",
    reserveVisit: "Rezervă o Vizită",
    admissionDossier: "Dosarul de Admitere",
    admissionDescription:
      "Descarcă documentele necesare pentru înscrierea copilului tău la grădinița Jules Verne.",
    downloadDocuments: "Descarcă Documentele",
    openEnrollment: "Înscrieri Deschise!",
    enrollmentDescription:
      "Locuri disponibile pentru anul școlar 2024-2025. Contactează-ne pentru detalii!",

    // Footer
    footerDescription:
      "Grădinița privată Jules Verne - unde fiecare copil pornește în aventura învățării într-un mediu sigur, stimulativ și plin de dragoste.",
    quickContact: "Contact Rapid",
    allRightsReserved:
      "© 2024 Grădinița Jules Verne. Toate drepturile rezervate.",
  ...
  ru: {
    ...
    // Hero
    eliteKindergarten: "Частный детский сад",
    adventuresInLearning: "Приключения в обучении",
    heroDescription:
      "Откройте для себя волшебный мир обучения вместе с нами! В Жюль Верне каждый день - это новое приключение, полное исследований, творчества и радости.",
    ...
    aboutDescription:
      "Уже более 15 лет детский сад Жюль Верн является особым местом, где дети учатся, исследуют и развивают свою личность в безопасной и стимулирующей среде.",
    ourMission: "Наша миссия",
    missionDescription1:
      "Вдохновленные авантюрным духом Жюля Верна, мы создаем для детей мир, полный открытий и обучения. Каждый день в нашем детском саду - это новое путешествие во вселенную знаний.",
    missionDescription2:
      "Наши основные ценности - это уважение, творчество, сотрудничество и радость обучения. Мы готовим детей к будущему, развивая их уверенность в себе и любовь к знаниям.",
    aracipAccreditation: "Аккредитация ARACIP",
    approvedCurriculum:
      "Учебная программа, одобренная Министерством образования",
    satisfiedParents: "Довольных родителей",
    innovativeEducation: "Инновационная образовательная программа",
    innovativeEducationDesc:
      "Персонализированная учебная программа, которая стимулирует творчество и естественное любопытство детей.",
    qualifiedEducators: "Квалифицированные педагоги",
    qualifiedEducatorsDesc:
      "Наша команда увлеченных и сертифицированных учителей направляет детей с любовью.",
    flexibleSchedule: "Гибкое расписание",
    flexibleScheduleDesc:
      "Расписание, адаптированное к потребностям вашей семьи, с возможностями продления и дополнительными мероприятиями.",
    personalizedDevelopment: "Персонализированное развитие",
    personalizedDevelopmentDesc:
      "Индивидуальное внимание к каждому ребенку, уважая его темп развития.",

    // Programs
    ourPrograms: "Наши образовательные программы",
    programsDescription:
      "Каждая возрастная группа получает персонализированную программу, адаптированную к конкретным потребностям развития детей.",
    ...
    extracurricularDescription:
      "Мы дополняем образование дополнительными занятиями, которые развивают таланты и увлечения детей.",
    ...
    smallGroupDescription:
      "Первые шаги в мире образования через мягкий и соответствующий возрасту подход.",
    middleGroupDescription:
      "Исследование мира через творчество, эксперименты и интерактивные занятия.",
    bigGroupDescription:
      "Подготовка к школе через сложные занятия и развитие самостоятельности.",
    preparatoryGroupDescription:
      "Переход к начальному образованию через укрепление приобретенных навыков.",
    ...
    galleryDescription:
      "Следите за особыми моментами и ежедневными занятиями детей в Жюль Верне.",
    ...
    contactDescription:
      "Мы здесь, чтобы ответить на все ваши вопросы и помочь вам понять, почему Жюль Верн - идеальный выбор для вашего ребенка.",
    phone: "Телефон",
    ...
    visitDescription:
      "Приходите посмотреть, как проходит день в Жюль Верне! Мы предлагаем экскурсии для родителей и детей.",
    reserveVisit: "Забронировать визит",
    admissionDossier: "Документы для поступления",
    admissionDescription:
      "Скачайте необходимые документы для зачисления вашего ребенка в детский сад Жюль Верн.",
    downloadDocuments: "Скачать документы",
    openEnrollment: "Открыта запись!",
    enrollmentDescription:
      "Места доступны на 2024-2025 учебный год. Свяжитесь с нами для получения подробной информации!",

    // Footer
    footerDescription:
      "Частный детский сад Жюль Верн - где каждый ребенок начинает приключение обучения в безопасной, стимулирующей и полной любви среде.",
...
export const LanguageProvider = ({ children }: { children: ReactNode }) => {
  ...
  const t = (key: string): string => {
    return (
      translations[currentLanguage][key as keyof (typeof translations)["ro"]] ||
      key
    );
  };
